...
- **`LuaTable`:** A Lua table. Subtypes:
  ...
  - **`JsonObject<...>`:** Same as above, except that all object *values* must be of the specified type. For instance, a `JsonObject<JsonArray>` requires all its keys to have `JsonArray` values.
