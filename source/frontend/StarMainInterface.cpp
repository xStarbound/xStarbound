...
#endif
#ifdef XCLIENT_UNLOCKED
  escapeDialog->fetchChild<LabelWidget>("lblcopyright")->setText("By ^red;FezzedOne^reset;, OpenSB constributors, Chucklefish");
#else
  escapeDialog->fetchChild<LabelWidget>("lblcopyright")->setText("By ^red;FezzedOne^reset;, OpenSB constributors, Chucklefish");
#endif
  return escapeDialog;
