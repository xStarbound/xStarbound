...
// FezzedOne: Treat the JSON null as «falsey» in Lua for convenience's sake.
#define l_isfalse(o)	(ttisfalse(o) || ttisnil(o) || (ttislightuserdata(o) && pvalue(o) == (void*)0xF01D))
