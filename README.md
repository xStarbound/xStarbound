...
3. Install CMake, Git and the required build libraries for xStarbound:
   ...
   - *RPM/`dnf`-based distros:* `sudo dnf install gcc cmake git ninja-build mesa mesa-libGLU libXrender libXi libxkbcommon egl-wayland qt6-qtbase qt6-qtsvg SDL2-devel` (yes, Fedora doesn't come with a compiler preinstalled!)
...
3. Install CMake, Git and the required build libraries for xStarbound:
   ...
   - *RPM/`dnf`-based distros:* `sudo dnf install gcc cmake git ninja-build patchelf mesa mesa-libGLU libXrender libXi libxkbcommon egl-wayland xcb* libX11-xcb` (yes, Fedora doesn't come with a compiler preinstalled!)
