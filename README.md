...
- [Spenbed Starbound osb logo replacer] — another logo replacement mod for OpenStarbound and the like. Should be supported. The associated modpack is fully compatible with xStarbound as long as xSBCompat is installed.
