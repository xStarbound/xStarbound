...
- [Smart Drops Objects](https://steamcommunity.com/sharedfiles/filedetails/?id=3720232044) — server-side, and inadvertently requires xStarbound or OpenStarbound on the server as it uses a retail-incompatible merge patch.
