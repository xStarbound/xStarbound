...
- [Smart Doors](https://steamcommunity.com/sharedfiles/filedetails/?id=3578614609) — technically requires xStarbound v4.1.1+ or OpenStarbound v0.1.15+ to avoid a nil dereference on a callback due to the creator's incidental usage of poorly documented OpenStarbound callbacks.
