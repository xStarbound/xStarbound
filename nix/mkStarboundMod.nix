  ...
  prev: final: {
    passthru.xsbmod =
      let
        ...
        safeScriptsWarning = lib.optionalString (requiresConfig.safeScripts or false) ''
        ...
        '';
      in
      if (otherWarning + safeScriptsWarning) == "" then val else builtins.warn otherWarning val;
  }
)
