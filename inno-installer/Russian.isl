...
WizardSelectDir=Выбор папки Starbound
SelectDirDesc=Где находится ваша установка Starbound?
...
DirDoesntExist=Папка%n%n%1%n%nне существует. Для установки xSB-2 необходима существующая папка Starbound. Хотите создать папку в любом случае?
...
StarboundCheckError=Starbound, кажется, не установлен в этой папке. Пожалуйста, выберите свою папку Starbound.